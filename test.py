...
def main():
    # 输入目录和输出目录
    input_dir = "/home/jwt/Hybrid-CEC/benchmarks/pair_log_processed"
    output_dir = "/home/jwt/Hybrid-CEC/benchmarks/training_set"
    ...
    parser = deepgate.AigParser(tmp_dir='/home/jwt/python-deepgate/test')
    ...
    for root, dirs, files in os.walk(input_dir):
        for file in files:
            if file.endswith(".log"):
                ...
                # 获取对应的 AIG 文件路径
                aig_file = os.path.join('/home/jwt/python-deepgate/test', f"{os.path.splitext(file)[0]}.aiger")
