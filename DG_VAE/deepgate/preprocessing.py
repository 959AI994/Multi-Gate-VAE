...
def general_train_test_split_edges(data, val_ratio=0, test_ratio=0, directed=True):
    ...
    Args:
        ...
        [Disable] val_ratio (float, optional): The ratio of positive validation
            edges. (default: :obj:`0.05`)
        [Disable] test_ratio (float, optional): The ratio of positive test
